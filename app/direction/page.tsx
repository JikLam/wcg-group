...
const copy = {
  tc: {
    ...
    overviewTitle: "由多元專業\n走向協同價值",
    overviewText: [
      "我們相信，真正可持續的企業價值，來自專業能力與資源網絡之間的有效連結。集團以香港為基地，整合影視娛樂、企業融資及上市、品牌名店加盟、創新科技、建築工程、數碼推廣及家族傳承等範疇，按不同需要組合合適團隊。",
  ...
  sc: {
    ...
    overview: "集团发展概览", overviewTitle: "由多元专业\n走向协同价值",
    overviewText: ["我们相信，真正可持续的企业价值，来自专业能力与资源网络之间的有效连接。集团以香港为基地，整合影视娱乐、企业融资及上市、品牌名店加盟、创新科技、建筑工程、数字推广及家族传承等范畴，按不同需要组合合适团队。", "在保持各项业务专业自主的同时，集团亦建立共同品牌价值、合作标准与资源平台，让跨领域项目可以更清晰地规划、协调及推进。"],
