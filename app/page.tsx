...
const content = {
  ...
  sc: {
    ...
    explore: "探索集团业务", contactUs: "联系我们", established: "成立年份", sectors: "核心业务", base: "集团基地", year: "2022", seven: "七大范畴", hk: "香港",
    heroCaption: "钜泷集团・香港・2022",
    aboutKicker: "关于钜泷", aboutTitle: "以跨界视野\n推动企业持续成长",
    ...
    businessKicker: "集团业务", businessTitle: "七大业务\n共建企业生态", businessIntro: "集团整合七大专业范畴，所有服务内容均可于本页直接浏览，让企业及合作伙伴快速了解我们的能力与合作方向。",
    businesses: [
    ...
    collaborationKicker: "合作伙伴", collaborationTitle: "汇聚专业资源\n推进共同项目", collaborationIntro: "集团按项目需要连接企业、品牌、创业者与专业机构。合作可涵盖整合项目、品牌加盟、科技平台及专业顾问协调。",
    ...
    directionKicker: "发展方向", directionTitle: "让专业各展所长\n让资源彼此连接", directionText: "集团网站集中展示各项专业服务，并以 WCG 的共同价值、专业网络及企业管治连接不同团队，为客户提供更完整的跨领域方案。", stages: ["建立清晰的集团品牌", "连接各项专业服务", "拓展跨地域合作机会"],
  ...
  en: {
    ...
    heroTitle: "Connecting creativity with technology and capital\nCreating enduring value",
    ...
    explore: "Explore our businesses", contactUs: "Contact us", established: "Established", sectors: "Core businesses", base: "Group base", year: "2022", seven: "Seven sectors", hk: "Hong Kong",
    heroCaption: "WIN CHANCE GROUP · HONG KONG · 2022",
    ...
    businessKicker: "OUR BUSINESSES", businessTitle: "Seven businesses\nOne connected ecosystem", businessIntro: "WCG brings seven specialist fields together in one place. Every service is presented directly on this page so businesses and partners can quickly understand our capabilities and potential areas of collaboration.",
    businesses: [
    ...
    directionKicker: "OUR DIRECTION", directionTitle: "Specialist strengths\nConnected resources", directionText: "The Group website presents every specialist service in one place, connecting teams through WCG’s shared values, professional network and corporate governance to deliver more complete cross-sector solutions.", stages: ["Build a clear group identity", "Connect specialist services", "Expand cross-market partnerships"],
