...
const copy = {
  tc: {
    ...
    network: "合作網絡", networkTitle: "客戶及夥伴", networkText: "相關合作網絡涵蓋科技、醫療、金融、工業、快速消費品、汽車及地產等行業。標誌及商標屬其各自擁有人所有。",
  ...
  sc: {
    ...
    network: "合作网络", networkTitle: "客户及伙伴", networkText: "相关合作网络涵盖科技、医疗、金融、工业、快速消费品、汽车及地产等行业。标志及商标属其各自拥有人所有。",
  ...
  en: {
    ...
    network: "OUR NETWORK", networkTitle: "Clients and partners", networkText: "The network presented here spans technology, healthcare, finance, industry, consumer goods, automotive and property. All logos and trademarks belong to their respective owners.",
  ...
  return (
    <main className="partners-page">
      ...
      <section className="partners-network">
        ...
        <figure><img src="/partners/wcg-partners.png" alt={t.networkTitle} /></figure>
      </section>
