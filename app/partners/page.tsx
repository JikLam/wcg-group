...
const copy = {
  tc: {
    ...
    modes: "合作方式", modesTitle: "由需要出發\n組合合適資源", cards: [["策略及項目合作", "釐清目標及項目範圍，按需要整合集團內外的專業團隊。"], ["科技及平台合作", "就企業網絡、數據、安全、防偽及自動化方案探索合作。"], ["品牌及加盟合作", "提供 LPA 品牌授權、營運模式與支援，並按正式加盟文件及協議推進。"], ["專業服務協作", "就融資、上市、家族傳承及建築工程協調合資格專業人士。"]],
  ...
  sc: {
    ...
    modes: "合作方式", modesTitle: "由需要出发\n组合合适资源", cards: [["策略及项目合作", "厘清目标及项目范围，按需要整合集团内外的专业团队。"], ["科技及平台合作", "就企业网络、数据、安全、防伪及自动化方案探索合作。"], ["品牌及加盟合作", "提供 LPA 品牌授权、营运模式与支持，并按正式加盟文件及协议推进。"], ["专业服务协作", "就融资、上市、家族传承及建筑工程协调合资格专业人士。"]],
