...
export const services: ServiceRecord[] = [
  ...
  {
    slug: "lpa-franchise", index: 3, image: "/services/classic-automotive.jpg", imageWidth: 980, imageHeight: 549, imagePosition: "center center", imageFit: "cover", gallery: ["/services/lpa-franchise-02.jpg", "/services/lpa-franchise-03.jpg"],
    content: {
      tc: { title: "品牌名店加盟", short: "以經典汽車文化與多元零售體驗，拓展品牌營運及加盟合作。", overview: "集團擁有 LPA 汽車品牌的全球獨家營運及加盟權，業務已拓展至中國八個城市。品牌生態涵蓋經典名車展示、收藏、銷售、維修與改裝，以及動漫娛樂與零售體驗，並為合作夥伴提供品牌授權、營運模式及支援服務。", offerings: ["國際經典名車博物館、會所及旗艦店", "汽車維修綜合體、護理及改裝門店", "動漫娛樂城、動漫 IP 店及模型車零售", "品牌授權、加盟模式與創業支援"], audiences: ["有意發展品牌業務的創業者", "具備場地、客戶網絡或營運資源的合作方", "汽車、文化娛樂及零售業投資者"] },
      sc: { title: "品牌名店加盟", short: "以经典汽车文化与多元零售体验，拓展品牌营运及加盟合作。", overview: "集团拥有 LPA 汽车品牌的全球独家营运及加盟权，业务已拓展至中国八个城市。品牌生态涵盖经典名车展示、收藏、销售、维修与改装，以及动漫娱乐与零售体验，并为合作伙伴提供品牌授权、营运模式及支持服务。", offerings: ["国际经典名车博物馆、会所及旗舰店", "汽车维修综合体、护理及改装门店", "动漫娱乐城、动漫 IP 店及模型车零售", "品牌授权、加盟模式与创业支持"], audiences: ["有意发展品牌业务的创业者", "具备场地、客户网络或营运资源的合作方", "汽车、文化娱乐及零售业投资者"] },
      en: { title: "Brand Franchise", short: "Growing brand operations and franchise partnerships through classic-car culture and diverse retail experiences.", overview: "The Group holds global exclusive operating and franchise rights for the LPA automotive brand, with operations expanded to eight cities in China. Its ecosystem spans classic-car display, collection, sales, maintenance and customisation, alongside animation entertainment and retail experiences, supported by brand licensing and operating guidance for partners.", offerings: ["International classic-car museums, clubs and flagship stores", "Maintenance complexes, car-care and customisation stores", "Animation entertainment, IP stores and model-car retail", "Brand licensing, franchise models and entrepreneur support"], audiences: ["Entrepreneurs developing a branded business", "Partners with venues, customer networks or operating resources", "Automotive, entertainment and retail investors"] },
    },
  },
  {
  ...
  {
    slug: "family-succession", index: 7, image: "/services/family-succession.jpg", imageWidth: 974, imageHeight: 1400, imagePosition: "center 35%", imageFit: "cover", gallery: ["/services/family-succession-02.jpg", "/services/family-succession-03.jpg"],
    content: {
