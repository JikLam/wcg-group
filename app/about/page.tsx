...
const copy = {
  tc: {
    ...
    kicker: "關於鉅瀧", title: "整合專業能力\n連結發展機會", intro: "Win Chance Group Holdings Limited 於 2022 年成立，立足香港，業務涵蓋七個專業範疇。",
    ...
    philosophy: "集團理念", philosophyTitle: "追求極致\n創新共贏", values: [["以人為本", "尊重專業人才與合作夥伴，重視清晰溝通及共同目標。"], ["專業協作", "按項目需要連結合適團隊，讓策略、技術與執行互相配合。"], ["長遠關係", "以誠信和成果建立信任，與客戶及夥伴共同發展。"]],
  ...
  sc: {
    ...
    kicker: "关于钜泷", title: "整合专业能力\n连接发展机会", intro: "Win Chance Group Holdings Limited 于 2022 年成立，立足香港，业务涵盖七个专业范畴。",
    ...
    philosophy: "集团理念", philosophyTitle: "追求极致\n创新共赢", values: [["以人为本", "尊重专业人才与合作伙伴，重视清晰沟通及共同目标。"], ["专业协作", "按项目需要连接合适团队，让策略、技术与执行互相配合。"], ["长远关系", "以诚信和成果建立信任，与客户及伙伴共同发展。"]],
  ...
  return (
    <main className="about-page">
      ...
      <section className="subpage-hero about-hero">
        ...
        <div className="subpage-year"><small>EST.</small><strong>2022</strong><span>HONG KONG</span></div>
      </section>
